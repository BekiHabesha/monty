...
## <ins>**PROJECT_TITLE</ins>:** :floppy_disk:   [**0x19. C - Stacks, Queues - LIFO, FIFO**](https://intranet.alxswe.com/projects/249)
...
<p align="center">
  <img src="https://d1avenlh0i1xmr.cloudfront.net/6b2aab83-a5d3-47fa-8db6-19ff9d3ee5af/push-and-pop-operations-in-stack---teachoo.png" />
...
* Any **output must be printed on <ins>stdout</ins>.**
...
```js
BekiHabesha@ubuntu:~/monty$ cat -e bytecodes/000.m
push 0$
push 1$
push 2$
  push 3$
...
```js
BekiHabesha@ubuntu:~/monty$ cat -e bytecodes/001.m
